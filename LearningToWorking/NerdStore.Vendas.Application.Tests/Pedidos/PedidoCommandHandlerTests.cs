...
namespace NerdStore.Vendas.Application.Tests.Pedidos
{
    public class PedidoCommandHandlerTests
    {
        ...
        [Trait("TDD", "Vendas - Pedido Command Handler")]
        ...
        public async Task AdicionarItem_NovoItemAoPedidoRascunho_DeveExecutarComSucesso()
        {
            ...
            var pedidoCommand = new AdicionarItemPedidoCommand(clienteId, Guid.NewGuid(), "Produto Teste", 1, 200);
        ...
        public async Task AdicionarItem_ItemExistenteAoPedidoRascunho_DeveExecutarComSucesso()
        {
            ...
            var pedidoCommand = new AdicionarItemPedidoCommand(clienteId, produtoId, "Produto Teste", 1, 100);
        ...
        [Trait("TDD", "Vendas - Pedido Command Handler")]
        public async Task AdicionarItem_CommandInvalido_DeveRretornarFalsoELancarEventosNotificacao() {
